...
public class ECScoreItem implements TextItemType
{
    public Label label;
    public ECScoreField field;
    private int y;
    private int x;
    int xspace=6;
    int yspace=24;
    ...
    public ECScoreItem(String lab, int x, int y)
    {
        lab = lab.trim();
        this.label = new Label(lab);
        field = new ECScoreField();
        this.y=y;
        this.x=x;
