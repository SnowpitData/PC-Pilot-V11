...
public class SlopeAngleTextItem implements TextItemType
{
    public Label label;
    public SlopeAngleTextField field = new SlopeAngleTextField();
    private int y;
    int xspace=6;
    ...
    public SlopeAngleTextItem(String lab, int x, int y)
    {
        lab = lab.trim();
