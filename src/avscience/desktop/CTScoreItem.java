...
public class CTScoreItem implements TextItemType
{
    public Label label;
    public CTScoreField field;
    private int y;
    private int x;
    int xspace=6;
    int yspace=24;
    ...
    public CTScoreItem(String lab, int x, int y)
    {
        lab = lab.trim();
        this.label = new Label(lab);
        field = new CTScoreField();
        this.y=y;
        this.x=x;
