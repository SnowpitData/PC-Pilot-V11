...
public class IntTextItem implements TextItemType
{
    public Label label;
    public ElvTextField field = new ElvTextField();
    private int y;
    private int x;
    int xspace=6;
    int yspace=24;
    ...
    public IntTextItem(String lab, int x, int y)
    {
        lab = lab.trim();
        this.label = new Label(lab);
        field = new ElvTextField();
        this.y=y;
        this.x=x;
    ...
    public IntTextItem(String lab, int x, int y, boolean vert)
    {
    	this.vert=vert;
    	lab = lab.trim();
        this.label = new Label(lab);
