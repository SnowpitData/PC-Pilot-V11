...
public class UTMTextItem implements TextItemType
{
    public Label label;
    public UTMTextField field = new UTMTextField("0");
    private int y;
    private int x;
    int xspace=6;
    int yspace=24;
    ...
    public UTMTextItem(String lab, int x, int y)
    {
        lab = lab.trim();
        this.label = new Label(lab);
        field = new UTMTextField("");
        this.y=y;
        this.x=x;
    ...
    public UTMTextItem(String lab, int x, int y, boolean vert)
    {
    	this.vert=vert;
    	lab = lab.trim();
        this.label = new Label(lab);
