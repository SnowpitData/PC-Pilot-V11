...
public class RhoTextItem implements TextItemType
{
    public Label label;
    public RhoTextField field;
    ...
    public RhoTextItem(String lab, String units, int x, int y)
    {
    	field = new RhoTextField(units);
        lab = lab.trim();
    ...
    public RhoTextItem(String lab, String units)
    {
    	this(lab, units, 1, 1);
    }
