...
public class ElvTextItemOp implements TextItemOp
{
    public Label label;
    ...
    public ElvTextItemOp(String lab, String units, int x, int y)
    {
        lab = lab.trim();
    ...
    /*public ElvTextItemOp(String lab, String units, int x, int y, boolean vert)
    {
    	this.vert=vert;
    	lab = lab.trim();
        this.label = new Label(lab);
    ...
    public ElvTextItemOp(String lab, String units)
    {
    	this(lab, units, 1, 1);
    }
